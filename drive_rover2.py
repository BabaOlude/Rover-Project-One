...
from perception2 import perception_step
from decision2 import decision_step
from supporting_functions2 import update_rover, create_output_images
...
ground_truth = mpimg.imread('../Python Programs/map_bw.png')
...
class RoverState():
    def __init__(self):
        ...
        self.stuck_time = 0 # To time the rover is stuck
        self.rock_time = 0 # To record rock sample retreival time
        ...
        self.brake_set = 8 # Brake setting when braking
        ...
        self.max_vel = 3.5 # Maximum velocity (meters/second)
